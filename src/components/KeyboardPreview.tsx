...
const OVERLAY_KEYS: OKey[] = [
  ...
  { label:'F5',   cx:328, cy:46, w:43, h:48 },
  { label:'F6',   cx:381, cy:46, w:41, h:48 },
  { label:'F7',   cx:433, cy:46, w:41, h:48 },
  { label:'F8',   cx:487, cy:46, w:45, h:48 },
  { label:'F9',   cx:550, cy:46, w:49, h:48 },
  { label:'F10',  cx:602, cy:46, w:48, h:48 },
  { label:'F11',  cx:654, cy:46, w:48, h:48 },
  { label:'F12',  cx:707, cy:46, w:49, h:48 },
  { label:'Del',  cx:772, cy:46, w:49, h:48 },
  // ── number row cy=110 h=49 ────────────────────────────────────────────────
  { label:'`',    cx:44,  cy:110, w:50, h:49 },
  ...
  { label:'7',    cx:408, cy:110, w:48, h:49 },
  { label:'8',    cx:460, cy:110, w:48, h:49 },
  { label:'9',    cx:512, cy:110, w:48, h:49 },
  { label:'0',    cx:564, cy:110, w:48, h:49 },
  { label:'-',    cx:616, cy:110, w:48, h:49 },
  { label:'=',    cx:666, cy:110, w:48, h:49 },
  { label:'Bksp', cx:747, cy:110, w:97, h:49 },
  { label:'Home', cx:848, cy:110, w:49, h:49, nav:true },
  // ── QWERTY row cy=162 h=49 ───────────────────────────────────────────────
  { label:'Tab',  cx:56,  cy:162, w:72, h:49 },
  ...
  { label:'K',    cx:498, cy:214, w:48, h:49 },
  ...
  { label:'PgDn', cx:848, cy:214, w:50, h:49, nav:true },
  ...
  { label:'↑',    cx:784, cy:281, w:48, h:48, nav:true },
  ...
  { label:'Ctrl', cx:668, cy:319, w:47, h:48 },
      ...
      {OVERLAY_KEYS.map((k, i) => (
        <div
          ...
          style={{
            ...
            fontSize: `${(k.w / IMG_W) * 100 * 0.25}cqw`,
          }}
          title={k.label}
        >
          {k.label}
